...
class rent : public customer // inhereted class from customer class
{
	...
	void data()
	{
        ...
        do
        {
          ...
          cout<<"\t\t\t\tEnter 'A' for TATA   NEXON EV "<<endl;
          cout<<"\t\t\t\tEnter 'B' for HYUNDAI IONIQ EV "<<endl;
         cout<<"\t\t\t\tEnter 'C' for MAHINDRA XUV4OO EV "<<endl;
            cout<<endl;
         ...
         cout<<endl;
           ...
           if(carmodel=="A")
          {
		    ...
		    cout<<"You have choosed TATA NEXON EV "<<endl;
        ...
        if(carmodel=="B")
        {
		    ...
		    cout<<"You have choosed  HYUNDAI IONIQ EV"<<endl;
   ...
   if(carmodel=="C")
    {
 	        system("CLS");
	     cout<<"You have choosed MAHINDRA XUV4OO EV  "<<endl;
